...
export const token = {
  get:   ()  => localStorage.getItem('toolkit_token') || localStorage.getItem('enigoal_token'),
  set:   (t) => localStorage.setItem('toolkit_token', t),
  clear: ()  => { localStorage.removeItem('toolkit_token'); localStorage.removeItem('enigoal_token'); },
};
...
export const usersAPI = {
  ...
  recordPlainPassword: (id, plainPassword) => patch(`/users/${id}/plain-password`, { plainPassword }),
  toggleStatus:        (id, isActive) => patch(`/users/${id}/status`, { isActive }),
